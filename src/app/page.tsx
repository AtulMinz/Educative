...
export default function Home() {
  return (
    <main className="bg-gradient-to-b from-[#0F2167] via-blue-900 to-blue-700">
      <Navbar />
      <div className="flex justify-center p-24 h-[100vh]">
        <div className="flex flex-col pt-20 items-center">
          ...
          <div className="flex justify-center items-center border-2 border-gray-500 w-3/6 h-14 hover:bg-blue-950 rounded-lg">
            <button className="mr-4 pr-4">
              <IoSearch className="fill-white" />
            </button>
            <input
              className="mt-1 bg-inherit w-4/5 h-1/2 mb-2 text-white focus:outline-none"
              type="text"
